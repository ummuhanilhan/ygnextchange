    ...
    return (
      <div className={classnames(
       ...
       {'error': error},
          ...
          <div className={classNames(
            'input flex items-center justify-end  relative rounded-md w-full h-[55px]',
             border? 'borde border-gray-300 border-opacity-25' : 'border-none border-gray-300 border-opacity-00',
             mini && 'h-[55px]',
             !height && 'h-[4em]',
             height && `h-[${height}]`,
            {'active':active},
