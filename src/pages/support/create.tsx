  ...
  return (
    <Frame>
      <div className="grid grid-cols-2 gap-4 w-full">
        <div>
          <IconFrame
            icon={<Message className="menu-icon" />}
            title="Bize Ulaşın"
          />
          <form onSubmit={handleSubmit(onSubmit, onError)}>
            ...
            <Box className="flex items-start">
              ...
              <input
                type="text"
                className="ml-3 w-full text-md text-gray-500 outline-none"
                value="Örnek Konu 1"
              />
            </Box>
            <Box className="flex items-start">
              ...
              <textarea
                name=""
                className="ml-3 w-full h-32 text-md text-gray-500 outline-none"
              >
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsam
                doloremque soluta, aut consectetur quisquam modi? Sapiente
                molestias voluptatem nihil? Excepturi quos asperiores
        ...
        <div className="w-full h-full bg-map object-contain"></div>
      </div>
    </Frame>
  );
};
