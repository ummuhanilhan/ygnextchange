      ...
      <div>
        ...
        <div className="heading grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="px-5 py-2 bg-yg-blue text-white flex-center w-full rounded-lg cursor-pointer">
            <a href="/contact">Yeni Destek Talebi Oluştur</a>
          </div>
        </div>
      ...
      <div className="flex items-center mt-3 ">
        <div
          className={classNames(
            `border-[1.5px] w-4 h-4 flex items-center mr-1 justify-center rounded-full`,
            border
          )}
        >
          <Warn
  ...
  return (
    ...
    >
      <div className="flex items-start">
        ...
        <div className={classNames("ml-2", !item.err && item.read && "gray")}>
          <h3
            className={classNames(
      ...
      <div>
        <div className="button px-5 py-1 bg-yg-blue text-white rounded-md">
          <a href="/support/chat">Yanıtla</a>
        </div>
      </div>
    </li>
  );
