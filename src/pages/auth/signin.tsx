...
export const Signin = () => {
  ...
  const onError = (errors: any) => {
    notify("Boş alanları doldurunuz!", {
        ...
        >
          ...
          <div className="flex justify-between w-full my-2">
            ...
            <a href="/auth/forgotten" className="cursor-pointer">
              <p className="text-lightgray text-sm text-gray-600">
                Şifremi Unuttum
              </p>
            </a>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="text-white align-center bg-yg-blue focus:ring-4 focus:ring-blue-300 font-medium 
          ...
          <div className="flex justify-end items-end w-full mt-6">
            <a href="/auth/signup" className="text-yg-orange text-sm ml-2">
