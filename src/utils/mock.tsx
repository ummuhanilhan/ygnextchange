...
export const profileTabMenu = [
  {
    id: 1,
    title: "Profilim",
    icon: <PersonCheck className="menu-icon" />,
    path: "/account",
  },
  {
    id: 2,
    title: "Şifremi Değiştir",
    icon: <ShieldCheck className="menu-icon" />,
...
export const cargoCreateTabMenu = [
  {
    ...
    icon: <Truck className="menu-icon" />,
    slug: "rent",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    icon: <MinecartLoaded className="menu-icon" />,
    slug: "payload",
  },
];
...
export const items = [
  {
    ...
    fav: true,
    view: 125,
    time: "1-3 Gün içerisinde",
    vehicle: "Tır 13.60 Açık",
    weight: "27 Ton",
    date: "22.07.2022 - 25.08.2022",
    load: "Ankara",
    unload: "Mersin",
    distance: "500KM",
  },
  ...
  },
  {
    ...
    fav: true,
    view: 93415,
    time: "1 hafta içerisinde",
    vehicle: "Kamyon 25.60 Kapalı",
    weight: "15 KM",
    date: "22.07.2019 - 03.00.2019",
    load: "Hakkari",
    unload: "Hatay",
    distance: "40KM",
  },
  ...
  },
  {
    ...
    fav: false,
    view: 349085,
    time: "1 ay içerisinde",
    vehicle: "Frigofirik 76.93 Açık",
    weight: "8 Ton",
    date: "22.07.2022 - 03.00.2022",
    load: "Yozgat",
    unload: "Konya",
    distance: "87420KM",
  },
...
export const tagItems = [
  ...
  { id: 4, slug: "truck1", value: "Damperli Kamyon / Kırkayak", label: "" },
  {
    id: 5,
    slug: "18wheel1",
    value: "Isı Kontrollü Kamyon / Kırkayak",
    label: "",
  },
  {
    id: 6,
    slug: "trailertruck1",
    value: "Konteyner Dorsesi (Kılçık Dorsesi)",
    label: "",
  },
...
export const notificationList = [
  {
    id: 1,
    icon: <Check height={13} />,
    action: "Yeni Yük Eklendi",
    message: "Adana - Mersin konumu için yeni yük eklendi.",
    type: "info",
    read: false,
  },
  {
    id: 2,
    icon: <Doublecheck height={15} />,
    action: "Yeni Yük Eklendi",
    message: "Adana - Mersin konumu için yeni yük eklendi.",
    type: "info",
    read: true,
  },
  {
    ...
    icon: <Warn height={20} />,
    err: true,
    action: "Araç Sigorta Gününüz Yaklaştı",
    message:
      "06 YKGTR 34 plakalı aracınızın sigortası 16.09.2022 tarihinde bitecektir. Sigortanızı hızla bir şekilde yenilemek için tıklayınız.",
    type: "err",
    read: true,
  },
];
...
export const issues = [
  {
    title: "İlan Ekleme Sorunu",
    body: "Merhaba, yeni ilan eklerken sorun yaşıyorum",
    status: "pending",
  },
  {
    title: "İlan Ekleme Sorunu",
...
export const dummyItem = {
  ...
  shipping: {
    range: ["2022-07-14T21:00:00.000Z", "2022-07-28T21:00:00.000Z"],
    time: "test deneme",
    unload: {
      geolocation: {
